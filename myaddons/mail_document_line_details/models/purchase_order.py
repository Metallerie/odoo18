            ...
            <div style="margin-top:16px;margin-bottom:16px;">
                ...
                <table style="border-collapse:collapse;width:100%;font-size:13px;">
                    <thead>
                        <tr style="background-color:#f5f5f5;">
                            <th style="padding:6px;border:1px solid #ddd;text-align:left;">
                                Désignation
                            </th>
                            <th style="padding:6px;border:1px solid #ddd;text-align:right;">
                                Qté
                            </th>
                            <th style="padding:6px;border:1px solid #ddd;text-align:left;">
                                Unité
                ...
                <div style="margin-top:12px;text-align:right;font-size:13px;">
                    <div>
                        ...
                        {self.amount_untaxed:.2f} {currency}
                    </div>

                    <div>
                        <strong>TVA :</strong>
                        {self.amount_tax:.2f} {currency}
                    </div>

                    <div style="font-size:15px;margin-top:4px;">
                        <strong>Total TTC :</strong>
                        {self.amount_total:.2f} {currency}
                    </div>
                </div>
            </div>
        """)
